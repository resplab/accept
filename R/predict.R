...
Sp_Manual_Vec <- function(data, CoefEst, knots, Boundary_knots) {
  ...
  data$predicted_exac_rate <- abs(Sp_Manual_Pred(data$predicted_exac_rate, CoefEst, knots, Boundary_knots))
  data$predicted_exac_rate_lower_PI <- abs(Sp_Manual_Pred(data$predicted_exac_rate_lower_PI, CoefEst, knots, Boundary_knots))
  data$predicted_exac_rate_upper_PI <- abs(Sp_Manual_Pred(data$predicted_exac_rate_upper_PI, CoefEst, knots, Boundary_knots))
  data$predicted_severe_exac_rate <- abs(Sp_Manual_Pred(data$predicted_severe_exac_rate, CoefEst, knots, Boundary_knots))
  data$predicted_severe_exac_rate_lower_PI <- abs(Sp_Manual_Pred(data$predicted_severe_exac_rate_lower_PI, CoefEst, knots, Boundary_knots))
  data$predicted_severe_exac_rate_upper_PI <- abs(Sp_Manual_Pred(data$predicted_severe_exac_rate_upper_PI, CoefEst, knots, Boundary_knots))
  ...
  # For azithromycin
  data$azithromycin_predicted_exac_rate <- abs(Sp_Manual_Pred(data$azithromycin_predicted_exac_rate, CoefEst, knots, Boundary_knots))
  data$azithromycin_predicted_exac_rate_lower_PI <- abs(Sp_Manual_Pred(data$azithromycin_predicted_exac_rate_lower_PI, CoefEst, knots, Boundary_knots))
  data$azithromycin_predicted_exac_rate_upper_PI <- abs(Sp_Manual_Pred(data$azithromycin_predicted_exac_rate_upper_PI, CoefEst, knots, Boundary_knots))
  data$azithromycin_predicted_severe_exac_rate <- abs(Sp_Manual_Pred(data$azithromycin_predicted_severe_exac_rate, CoefEst, knots, Boundary_knots))
  data$azithromycin_predicted_severe_exac_rate_lower_PI <- abs(Sp_Manual_Pred(data$azithromycin_predicted_severe_exac_rate_lower_PI, CoefEst, knots, Boundary_knots))
  data$azithromycin_predicted_severe_exac_rate_upper_PI <- abs(Sp_Manual_Pred(data$azithromycin_predicted_severe_exac_rate_upper_PI, CoefEst, knots, Boundary_knots))
